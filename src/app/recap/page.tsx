...
import { ArrowLeft, Clock, Loader2, Copy, RotateCcw } from 'lucide-react';
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 mb-6">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                placeholder="例如：第100章主角做了什么？主角和A的关系如何？..."
                className="w-full h-32 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 resize-none transition-all"
                disabled={loading}
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                placeholder="如果有相关的章节内容或剧情片段，可以在这里提供，能帮助AI更准确地回顾剧情..."
                className="w-full h-24 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 resize-none transition-all"
                disabled={loading}
              />
            </div>
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-500 dark:text-gray-400">
                问题: {query.length} / 500 | 背景: {context.length} / 2000
              </span>
              <button
                onClick={handleGenerate}
                disabled={loading || !query.trim()}
                className="px-6 py-2.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-medium rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {loading ? (
                  <>
